...
#SERVER AD
#LDAP_SERVER="ldap://jkt-example.example.co.id:389"
#DOMAIN="jkt-example.example.co.id"
...
do
  echo -n " - Adding $i ";
  $ZMPROV createAccount $i passwd zimbraMailHost mbox02.example.co.id > /dev/null;
  RES=$?
